  ...
  <div class="hitl-card" :class="`hitl-card--${cardType}`">
    ...
    <div v-else-if="cardType === 'confirm' && confirm" class="hitl-card__confirm">
      ...
      <div class="confirm-actions">
        <button class="confirm-btn confirm-btn--cancel" @click="cancelConfirm">
          {{ confirm.cancelAction.label }}
        </button>
        <button class="confirm-btn" :class="`confirm-btn--${confirm.riskLevel}`" @click="confirmAction">
    ...
    <div v-else-if="cardType === 'slot-fill' && slotFill" class="hitl-card__slot-fill">
      ...
      <div class="slot-fill-actions">
        <button class="confirm-btn confirm-btn--cancel" @click="cancelSlotFill">
...
import type { InteractionChoice, InteractionOption, ConfirmRequest, SlotFillRequest, SlotDefinition } from './useChat'
