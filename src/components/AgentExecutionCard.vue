...
.pip--active .pip-dot    { background: var(--vp-c-brand-1, #0078d4); transform: scale(1.3); box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.18); }
.pip--warn .pip-dot     { background: #e3b341; }
.pip--err .pip-dot      { background: #f85149; }
.pip--pending .pip-dot  { background: var(--vp-c-divider, #d0d7de); }
...
.step-card--active {
  border-color: var(--vp-c-brand-1, #0078d4);
  box-shadow: 0 0 0 1px var(--vp-c-brand-1, #0078d4);
}
...
.step-card__header:hover { background: var(--vp-c-bg, #ffffff); }
...
.num--active   { border-color: var(--vp-c-brand-1, #0078d4); color: var(--vp-c-brand-1, #0078d4); }
...
.num-pip--pending { background: var(--vp-c-divider, #d0d7de); }
...
.spinner {
  width: 14px;
  height: 14px;
  border: 2px solid var(--vp-c-brand-1, #0078d4);
...
.tag--active     { background: rgba(0,120,212,0.12); color: var(--vp-c-brand-1, #0078d4); }
.tag--pending    { background: var(--vp-c-bg-soft, #f6f8fa);    color: var(--vp-c-text-3, #6e7781); border: 1px solid var(--vp-c-divider, #d0d7de); }
...
.chip--stat strong { color: var(--vp-c-text-1, #1f2328); }
...
.connector-badge--running { background: rgba(0,120,212,0.12); color: var(--vp-c-brand-1, #0078d4); }

.connector-name { font-weight: 600; color: var(--vp-c-text-1, #1f2328); flex: 1; }
.connector-count { color: var(--vp-c-brand-1, #0078d4); font-weight: 700; }
.connector-latency { color: var(--vp-c-text-3, #6e7781); font-size: 0.7rem; }
...
.exec-name { font-weight: 600; font-size: 0.78rem; color: var(--vp-c-text-1, #1f2328); flex: 1; }
...
.exec-status--running { color: var(--vp-c-brand-1, #0078d4); }
.exec-status--pending { color: var(--vp-c-text-3, #6e7781); }
.exec-status--timeout { color: #e3b341; }
.exec-latency { font-size: 0.7rem; color: var(--vp-c-text-3, #6e7781); }
...
.suggested-action-btn {
  padding: 5px 12px;
  border: 1px solid var(--vp-c-brand-1, #0078d4);
  border-radius: 6px;
...
.suggested-action-btn:hover {
  background: var(--vp-c-brand-1, #0078d4);
  color: #fff;
}
...
.suggested-action-btn--execute { border-color: var(--vp-c-brand-1, #0078d4); color: var(--vp-c-brand-1, #0078d4); }
.suggested-action-btn--execute:hover { background: var(--vp-c-brand-1, #0078d4); color: #fff; }
